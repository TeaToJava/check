...
public class Product {
    ...
    public boolean equals(Object o) {
        ...
        return id == product.id && Double.compare(price, product.price) == 0 && isWholesaleProduct == product.isWholesaleProduct && Objects.equals(description, product.description);
    }
