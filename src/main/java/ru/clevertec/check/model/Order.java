  ...
  //заменить на builder
   private Order(OrderBuilder orderBuilder) {
    ...
    public boolean equals(Object o) {
        ...
        Order order = (Order) o;
        return Double.compare(balanceDebitCard, order.balanceDebitCard) == 0 && Double.compare(totalPrice, order.totalPrice) == 0 && Double.compare(totalDiscount, order.totalDiscount) == 0 && Double.compare(totalWithDiscount, order.totalWithDiscount) == 0 && Objects.equals(products, order.products) && Objects.equals(discountCard, order.discountCard) && Objects.equals(dateTime, order.dateTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(products, discountCard, balanceDebitCard, dateTime, totalPrice, totalDiscount, totalWithDiscount);
    }
}
